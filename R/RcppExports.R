...
#'   
#' @export
ctmc.tpm <- function(t, subst_mod) {
    .Call(`_phylomd_ctmc_tpm`, t, subst_mod)
}
...
#'   
#' @export
phylo.likelihood <- function(tree, subst_mod, tip_states) {
    .Call(`_phylomd_phylo_likelihood`, tree, subst_mod, tip_states)
}
